...
{
    return SyscallEntry(SyscallIdGetPageFaultNo, AllocatedVirtAddr, PageFaultNo);
}
...
{
    return SyscallEntry(SyscallIdGetPagePhysAddr, AllocatedVirtAddr, AllocatedPhysAddr);
}
...
{
    return SyscallEntry(SyscallIdGetPageInternalFragmentation, AllocatedVirtAddr, IntFragSize);
}
