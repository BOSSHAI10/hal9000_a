...
//******************************************************************************
// Function:     SyscallGetPageFaultNo
// Description:  Returns the number of page faults for a virtual address page.
// Returns:      STATUS
// Parameter:    IN PVOID AllocatedVirtAddr - Virtual address to check
// Parameter:    OUT QWORD PageFaultNo - Number of page faults
//******************************************************************************
STATUS
...
//******************************************************************************
// Function:     SyscallGetPagePhysAddr
// Description:  Returns the physical address mapping for a virtual address.
// Returns:      STATUS
// Parameter:    IN PVOID AllocatedVirtAddr - Virtual address to check
// Parameter:    OUT PVOID* AllocatedPhysAddr - Physical address (NULL if not mapped)
//******************************************************************************
STATUS
...
//******************************************************************************
// Function:     SyscallGetPageInternalFragmentation
// Description:  Returns internal fragmentation size for a virtual page.
// Returns:      STATUS
// Parameter:    IN PVOID AllocatedVirtAddr - Virtual address to check
// Parameter:    OUT QWORD IntFragSize - Internal fragmentation in bytes
//******************************************************************************
STATUS
